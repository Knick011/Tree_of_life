(() => {
  ...
  app.getTourSteps = () => {
    ...
    return [
      { target: 'header', title: isFr ? 'Ce que la maquette montre' : 'What this mock shows', body: isFr ? 'Tree of Life montre deux chemins: un mode guide pour les cas moins familiers et un mode modele enregistre pour les prescriptions repetitives.' : 'Tree of Life shows two paths: a guided mode for less familiar cases and a saved-template mode for repeat prescribing.', tryText: isFr ? 'Relancez cette visite a tout moment pendant la demo.' : 'Restart this tour at any time during the demo.' },
